...
// search input field enter the key handler
...
const displayPhoneDetails = phone =>{
    ...
    <p>Release Date: ${phone.releaseDate ? phone.releaseDate : 'no releseDate found'}</p>
    <p>Storage : ${phone.mainFeatures ? phone.mainFeatures.storage : 'no storage found'}</p>
    <p> other: ${phone.others ?phone.others.Bluetooth : 'no Bluetooth found'}</p>
